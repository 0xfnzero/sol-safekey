...
### 11. PumpSwap 卖出（支持 Token-2022）

**用途**: 一键在 PumpSwap DEX 上卖出所有代币

**使用场景**: 快速退出 meme 币或在 PumpSwap 上的交易仓位
...
✅ 找到池子！
  ...
  池子余额: 5,000,000 / 2.5 SOL

💱 正在执行卖出...
  数量: 1,000,000 tokens (全部)
  滑点: 99% (9900 基点)
  DEX: PumpSwap

🚀 发送交易中...
✅ 卖出成功！
   交易签名 1: 5J7W8vN2BxC9K4...
   交易签名 2: 3K9X2nM5DyH8F7...
